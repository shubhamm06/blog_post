...
from . import views
from .views import UserRegisterView, UserEditView, PasswordChange, ProfileCreateView, profile, OthersProfileView
...
urlpatterns = [
    ...
    path('others_profile/<int:pk>',
         OthersProfileView.as_view(), name='others-profile')
]
